...
public class FieldConstantsClassBuilder {
    ...
    public FieldConstantsClassBuilder(ProcessingEnvironment processingEnvironment) {
        ...
        mFieldInterfaceMap = new MapBuilder<ColumnType, Type>()
                .put(ColumnType.PRIMITIVE_BOOLEAN, BOOLEAN_FIELD)
                .put(ColumnType.BOOLEAN, BOOLEAN_FIELD)
                .put(ColumnType.DATE, DATE_FIELD)
                .put(ColumnType.PRIMITIVE_DOUBLE, DOUBLE_FIELD)
                .put(ColumnType.DOUBLE, DOUBLE_FIELD)
                .put(ColumnType.ENTITY, ENTITY_FIELD)
                .put(ColumnType.PRIMITIVE_FLOAT, FLOAT_FIELD)
                .put(ColumnType.FLOAT, FLOAT_FIELD)
                .put(ColumnType.PRIMITIVE_INT, INT_FIELD)
                .put(ColumnType.INT, INT_FIELD)
                .put(ColumnType.PRIMITIVE_LONG, LONG_FIELD)
                .put(ColumnType.LONG, LONG_FIELD)
                .put(ColumnType.STRING, STRING_FIELD)
                .build();
        mFieldImplementationMap = new MapBuilder<ColumnType, Type>()
                .put(ColumnType.PRIMITIVE_BOOLEAN, BOOLEAN_FIELD_IMPL)
                .put(ColumnType.BOOLEAN, BOOLEAN_FIELD_IMPL)
                .put(ColumnType.DATE, DATE_FIELD_IMPL)
                .put(ColumnType.PRIMITIVE_DOUBLE, DOUBLE_FIELD_IMPL)
                .put(ColumnType.DOUBLE, DOUBLE_FIELD_IMPL)
                .put(ColumnType.ENTITY, ENTITY_FIELD_IMPL)
                .put(ColumnType.PRIMITIVE_FLOAT, FLOAT_FIELD_IMPL)
                .put(ColumnType.FLOAT, FLOAT_FIELD_IMPL)
                .put(ColumnType.PRIMITIVE_INT, INT_FIELD_IMPL)
                .put(ColumnType.INT, INT_FIELD_IMPL)
                .put(ColumnType.PRIMITIVE_LONG, LONG_FIELD_IMPL)
                .put(ColumnType.LONG, LONG_FIELD_IMPL)
                .put(ColumnType.STRING, STRING_FIELD_IMPL)
                .build();
    }
