...
public class LongSparseArrayCompat<E> implements Cloneable {
     ...
     */
    public LongSparseArrayCompat(int initialCapacity) {
    ...
    public LongSparseArrayCompat<E> clone() {
        LongSparseArrayCompat<E> clone = null;
        try {
            clone = (LongSparseArrayCompat<E>) super.clone();
